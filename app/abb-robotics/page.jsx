...
const robotsData = [
  {
    ...
    isNew: true,
    applications: ['Machine tending', 'Palletizing', 'Welding', 'Material handling', 'Loading and unloading', 'Assembly'],
    payload: '7 - 30 kg',
    reach: '1.34 - 1.96 m',
  ...
  },
  {
    ...
    isNew: true,
    applications: ['Line supply and kitting', 'Subassembly line', 'End-of-line handling', 'Goods-to-robot', 'Inter-process connection'],
  ...
  },
  {
    ...
    isNew: true,
    applications: ['Palletizing', 'Line supply and kitting', 'End-of-line handling', 'Goods-to-robot', 'Subassembly line', 'Inter-process connection'],
  ...
  },
  {
    ...
    isNew: true,
    applications: ['Line supply and kitting', 'End-of-line handling', 'Warehouse storage and retrieval', 'Inter-process connection'],
    payload: 'up to 2,000 kg',
    reach: 'Visual SLAM',
    payloadCategory: 'E',
    reachCategory: '',
  ...
  },
  {
    ...
    applications: ['Machine tending', 'Palletizing', '3D printing', 'Screwdriving', 'Material handling', 'Laser welding', 'Arc welding', 'Lab automation', 'Joining and sealing', 'Assembly'],
    payload: '5 kg',
    reach: '0.95 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'articulated',
    name: 'IRB 1010',
    applications: ['Material handling', 'Pick and place', 'Assembly'],
    payload: '1.5 kg',
    reach: '0.37 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'articulated',
    name: 'IRB 1090',
    applications: ['Material handling', 'Packaging', 'Testing and measuring', 'Pick and place', 'Assembly'],
    payload: '3.5 kg',
    reach: '0.58 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'articulated',
    name: 'IRB 1100',
    applications: ['Screwdriving', 'Material handling', 'Loading and unloading', 'Lab automation', 'Testing and measuring', 'Pick and place', 'Dispensing', 'Assembly', 'Surface finishing'],
    payload: '4 kg',
    reach: '0.475-0.58 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'articulated',
    name: 'IRB 1200',
    applications: ['Machine tending', '3D printing', 'Material handling', 'Packaging', 'Pick and place', 'Assembly'],
    payload: '5-7 kg',
    reach: '0.7-0.9 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    applications: ['Food & Beverage', 'Cleaning', 'Material handling', 'Lab automation'],
    payload: '5-7 kg',
    reach: '0.7-0.9 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'articulated',
    name: 'IRB 1300',
    applications: ['Machine tending', 'Material handling', 'Loading and unloading', 'Lab automation', 'Testing and measuring', 'Pick and place', 'Assembly'],
    payload: '7-12 kg',
    reach: '0.9-1.4 m',
    payloadCategory: 'A,B',
    reachCategory: 'A',
  ...
  },
  {
    ...
    applications: ['Food & Beverage', 'Material handling', 'Lab automation', 'Testing and measuring', 'Inspection', 'Assembly'],
    payload: '0.5 kg',
    reach: '0.5 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'articulated',
    name: 'IRB 1600',
    applications: ['Machine tending', 'Cleaning', 'Material handling', 'Packaging', 'Arc welding', 'Spraying', 'Dispensing', 'Assembly'],
    payload: '6-10 kg',
    reach: '1.2-1.45 m',
    payloadCategory: 'A,B',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'articulated',
    name: 'IRB 2600',
    applications: ['Machine tending', '3D printing', 'Cleaning', 'Material handling', 'Packaging', 'Arc welding', 'Spraying', 'Dispensing', 'Assembly'],
    payload: '12-20 kg',
    reach: '1.65-1.85 m',
    payloadCategory: 'B,C',
    reachCategory: 'A,B',
  ...
  },
  {
    ...
    type: 'delta',
    name: 'IRB 360',
    applications: ['Food & Beverage', 'Material handling', 'Packaging', 'Pick and place', 'Assembly'],
    payload: '1-8 kg',
    reach: 'Ø1.13 m',
    payloadCategory: 'A,B',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'delta',
    name: 'IRB 365',
    applications: ['Food & Beverage', 'Packaging', 'Pick and place'],
    payload: '1.5 kg',
    reach: 'Ø1.10 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'delta',
    name: 'IRB 390',
    applications: ['Food & Beverage', 'Material handling', 'Packaging', 'Pick and place'],
    payload: '8-15 kg',
    reach: 'Ø1.30 m',
    payloadCategory: 'B',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'articulated',
    name: 'IRB 4600',
    applications: ['Machine tending', 'Material handling', 'Arc welding', 'Dispensing', 'Assembly'],
    payload: '20-60 kg',
    reach: '2.05-2.55 m',
    payloadCategory: 'C',
    reachCategory: 'B',
  ...
  },
  {
    ...
    type: 'scara',
    name: 'IRB 910INV',
    applications: ['Screwdriving', 'Material handling', 'Loading and unloading', 'Lab automation', 'Testing and measuring', 'Pick and place', 'Assembly'],
    payload: '3-6 kg',
    reach: '0.35-0.55 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'scara',
    name: 'IRB 920T',
    applications: ['Food & Beverage', 'Material handling', 'Packaging', 'Loading and unloading', 'Lab automation', 'Pick and place', 'Assembly'],
    payload: '6 kg',
    reach: '0.45-0.65 m',
    payloadCategory: 'A',
    reachCategory: 'A',
  ...
  },
  {
    ...
    type: 'scara',
    name: 'IRB 930',
    applications: ['Screwdriving', 'Material handling', 'Packaging', 'Testing and measuring', 'Pick and place', 'Assembly'],
    payload: '12, 22 kg',
    reach: '0.85, 1.05 m',
    payloadCategory: 'B,C',
    reachCategory: 'A',
