...
import LabAutomationRobotCatalog from './LabAutomationRobotCatalog'
  ...
  return (
    <>
      ...
      <section className="cleanroom-industries-section">
        <div className="container">
          <h2 className="section-heading-center"><Tr id="abb-lab:industries:heading" /></h2>
          <p className="section-subheading-center">
            <Tr id="abb-lab:industries:subheading" />
          </p>
          ...
          <div className="industries-grid">
            <div className="industry-card">
              ...
              <div className="industry-content">
                <h3 className="industry-title"><Tr id="abb-lab:industry1:title" /></h3>
                <p className="industry-description">
                  <Tr id="abb-lab:industry1:desc" />
                </p>
              </div>
            </div>
            ...
            <div className="industry-card">
              ...
              <div className="industry-content">
                <h3 className="industry-title"><Tr id="abb-lab:industry2:title" /></h3>
                <p className="industry-description">
                  <Tr id="abb-lab:industry2:desc" />
                </p>
              </div>
            </div>
            ...
            <div className="industry-card">
              ...
              <div className="industry-content">
                <h3 className="industry-title"><Tr id="abb-lab:industry3:title" /></h3>
                <p className="industry-description">
                  <Tr id="abb-lab:industry3:desc" />
                </p>
              </div>
            </div>
            ...
            <div className="industry-card">
              ...
              <div className="industry-content">
                <h3 className="industry-title"><Tr id="abb-lab:industry4:title" /></h3>
                <p className="industry-description">
                  <Tr id="abb-lab:industry4:desc" />
                </p>
              </div>
            </div>
          </div>
