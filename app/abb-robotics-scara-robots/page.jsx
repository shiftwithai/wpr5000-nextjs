...
import ScaraRobotCatalog from './ScaraRobotCatalog'
import Tr from '../../components/Tr'
import WhyProaxImage from '../../components/WhyProaxImage'

export const metadata = {
  title: 'SCARA Robots - ABB Robotic Solutions | Proax',
  description: 'ABB SCARA robots for high-speed assembly, picking, and handling. Fast, accurate, and cost-effective automation for electronics and manufacturing.',
};
  ...
  return (
    <>
      ...
      <section className="cleanroom-industries-section">
        <div className="container">
          <h2 className="section-heading-center"><Tr id="abb-scara:industries:heading" /></h2>
          <p className="section-subheading-center">
            <Tr id="abb-scara:industries:subheading" />
          </p>
