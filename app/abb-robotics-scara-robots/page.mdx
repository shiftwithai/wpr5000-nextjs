      ...
      <div className="hero-visual">
        <div className="product-video-wrapper">
          ...
          <div className="image-badge">
            ...
            <span>High-Speed Precision</span>
          </div>
        </div>
      </div>
    </div>
...
<section className="cleanroom-benefits-section">
  <div className="container">
    ...
    <p className="section-subheading-center">
      Why choose ABB SCARA robots for your automation needs
    </p>
    ...
    <div className="benefits-grid">
      <div className="benefit-card">
        ...
        <h3 className="benefit-title">Class-Leading Speed</h3>
        <p className="benefit-description">
          Exceptional cycle times for high-throughput assembly and pick-and-place operations.
        </p>
      </div>
      ...
      <div className="benefit-card">
        ...
        <h3 className="benefit-title">High Accuracy</h3>
        <p className="benefit-description">
          Best-in-class repeatability for precision assembly and quality-critical applications.
        </p>
      </div>
      ...
      <div className="benefit-card">
        ...
        <h3 className="benefit-title">Flexible Mounting</h3>
        <p className="benefit-description">
          Floor or ceiling-mounted options for space savings and increased assembly flexibility.
        </p>
      </div>
      ...
      <div className="benefit-card">
        ...
        <p className="benefit-description">
          Optimized design delivers high performance at competitive cost of ownership.
        </p>
      </div>
    </div>
  </div>
...
<section className="cleanroom-industries-section">
  <div className="container">
    ...
    <p className="section-subheading-center">
      ABB SCARA robots deliver speed and precision across manufacturing sectors
    </p>
  ...
  <div className="container">
    <div className="why-proax-grid">
      ...
      <div className="why-proax-content">
        <h2 className="why-proax-heading">Why Proax for SCARA Robots</h2>
        <p className="why-proax-text">
          Proax is your trusted ABB SCARA robotics partner in Canada. Our ABB-certified engineers provide expert consultation, robot selection, and turnkey integration for high-speed assembly and pick-and-place applications.
        </p>
  ...
  <div className="container">
    <div className="quote-grid">
      <div className="quote-content">
        <h2 className="quote-heading">Request a Free SCARA Robot Assessment</h2>
        <p className="quote-description">
          Get expert guidance on selecting the right SCARA robot for your application. Our ABB-certified team is ready to help.
        </p>
        ...
        <div className="quote-features">
          ...
          <div className="quote-feature">
            ...
            <span>ABB SCARA Robot Expertise</span>
          </div>
          <div className="quote-feature">
            <svg className="quote-feature-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 12L11 14L15 10M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
