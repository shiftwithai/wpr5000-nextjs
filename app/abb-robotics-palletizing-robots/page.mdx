...
export const metadata = {
  title: 'Palletizing and Depalletizing Robots - ABB Robotic Solutions | Proax',
  description: 'ABB 4-axis palletizing and depalletizing robots for end-of-line operations. Fast, compact, and powerful robots for bags, boxes, crates, and bottles.',
};
    ...
    <div className="hero-grid">
      <div className="hero-content">
        <h1 className="hero-heading">
          ABB Palletizing and Depalletizing Robots
        </h1>
        
        <div className="hero-subheading">
          4-axis robots designed for high-speed end-of-line palletizing and depalletizing operations.
        </div>

        <p className="hero-supporting-text">
          ABB's palletizing and depalletizing robot portfolio features the fastest and most compact 4-axis robots in the industry. From the world's fastest palletizing robot to heavy-duty solutions for large payloads, our robots are designed to maximize throughput while fitting seamlessly into existing packing lines.
        </p>
      ...
      <div className="hero-visual">
        <div className="product-video-wrapper">
          ...
          <div className="image-badge">
            ...
            <span>World's Fastest Palletizing</span>
          </div>
        </div>
      </div>
    </div>
...
<section className="cleanroom-benefits-section">
  <div className="container">
    ...
    <p className="section-subheading-center">
      Why choose ABB 4-axis palletizing robots for your operations
    </p>
    ...
    <div className="benefits-grid">
      <div className="benefit-card">
        ...
        <h3 className="benefit-title">Fastest in the World</h3>
        <p className="benefit-description">
          The IRB 460 is the fastest palletizing robot in the world, maximizing throughput.
        </p>
      </div>
      ...
      <div className="benefit-card">
        ...
        <p className="benefit-description">
          Small footprint design ideal for fitting into existing packing lines.
        </p>
      </div>
      ...
      <div className="benefit-card">
        ...
        <h3 className="benefit-title">Heavy Payloads</h3>
        <p className="benefit-description">
          Handle payloads up to 450 kg for large and heavy products at high speeds.
        </p>
      </div>
      ...
      <div className="benefit-card">
        ...
        <h3 className="benefit-title">Versatile Applications</h3>
        <p className="benefit-description">
          Perfect for bags, boxes, crates, bottles, and more in any palletizing application.
        </p>
      </div>
    </div>
  </div>
...
<section className="cleanroom-industries-section">
  <div className="container">
    ...
    <p className="section-subheading-center">
      ABB Palletizing robots deliver speed and reliability across manufacturing sectors
    </p>
  ...
  <div className="container">
    <div className="why-proax-grid">
      ...
      <div className="why-proax-content">
        <h2 className="why-proax-heading">Why Proax for Palletizing Robots</h2>
        <p className="why-proax-text">
          Proax is your trusted ABB palletizing robotics partner in Canada. Our ABB-certified engineers provide expert consultation, robot selection, and turnkey integration for end-of-line palletizing applications.
        </p>
  ...
  <div className="container">
    <div className="quote-grid">
      <div className="quote-content">
        <h2 className="quote-heading">Request a Free Palletizing Robot Assessment</h2>
        <p className="quote-description">
          Get expert guidance on selecting the right palletizing robot for your application. Our ABB-certified team is ready to help.
        </p>
        ...
        <div className="quote-features">
          ...
          <div className="quote-feature">
            ...
            <span>ABB Palletizing Robot Expertise</span>
          </div>
          <div className="quote-feature">
            <svg className="quote-feature-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 12L11 14L15 10M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
